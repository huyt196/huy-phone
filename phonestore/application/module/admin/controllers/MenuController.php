...
class MenuController extends Controller{
	...
	public function indexAction(){
		$this->_view->_title 		= 'Menu Manager :: List';
	...
	public function formAction(){
		$this->_view->_title = 'Menu Manager :: Add';
		...
		if($this->_arrParam['form']['token'] > 0){
			...
			if($validate->isValid() == false){
				...
				if($this->_arrParam['type'] == 'save-close') 	URL::redirect('admin', 'menu', 'index');
				if($this->_arrParam['type'] == 'save-new') 		URL::redirect('admin', 'menu', 'form');
				if($this->_arrParam['type'] == 'save') 			URL::redirect('admin', 'menu', 'form', array('id' => $id));
			}
		}
		
		$this->_view->arrParam = $this->_arrParam;
		$this->_view->render('menu/form');
	}
