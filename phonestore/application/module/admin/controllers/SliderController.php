...
class SliderController extends Controller{
	...
	public function indexAction(){
		$this->_view->_title 		= 'Slider Manager :: List';
	...
	public function formAction(){
		$this->_view->_title = 'Slider : Add';
		$this->_view->slbCategory		= $this->_model->itemInSelectbox($this->_arrParam, null);
		if(!empty($_FILES)) $this->_arrParam['form']['picture']  = $_FILES['picture'];
		
		if(isset($this->_arrParam['id'])){
			$this->_view->_title = 'slider : Edit';
			$this->_arrParam['form'] = $this->_model->infoItem($this->_arrParam);
			if(empty($this->_arrParam['form'])) URL::redirect('admin', 'slider', 'index');
		}
		...
		if($this->_arrParam['form']['token'] > 0){
			...
			if($validate->isValid() == false){
				...
				if($this->_arrParam['type'] == 'save-close') 	URL::redirect('admin', 'slider', 'index');
				if($this->_arrParam['type'] == 'save-new') 		URL::redirect('admin', 'slider', 'form');
				if($this->_arrParam['type'] == 'save') 			URL::redirect('admin', 'slider', 'form', array('id' => $id));
			}
		}
	...
	public function statusAction(){
		...
		URL::redirect('admin', 'slider', 'index');
	}
