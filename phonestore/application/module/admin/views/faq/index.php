<?php 
	...
	$lblCreated_by	= Helper::cmsLinkSort('Created_by', 'created_by', $columnPost, $orderPost);
	$lblStatus		= Helper::cmsLinkSort('Status', 'status', $columnPost, $orderPost);

	$lblModified	= Helper::cmsLinkSort('Modified', 'modified', $columnPost, $orderPost);
	$lblModified_by	= Helper::cmsLinkSort('Modified_by', 'modified_by', $columnPost, $orderPost);
                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
								...
								<th class="title"><?php echo $lblQuestion;?></th>
								<th class="title"><?php echo $lblAnswer;?></th>
								<th width="7%"><?php echo $lblCreated;?></th>
								<th class="title"><?php echo $lblCreated_by;?></th>

                                <th width="5%"><?php echo $lblStatus;?></th>
                                
                                <th width="6%"><?php echo $lblOrdering;?></th>
                                <th width="7%"><?php echo $lblModified;?></th>
                                <th width="7%"><?php echo $lblModified_by;?></th>
				...
				<?php 
							if(!empty($this->Items)){
								...
								foreach($this->Items as $key => $value){
									...
									$row		= ($i % 2 == 0) ? 'row0' : 'row1';
									$status		= Helper::cmsStatus($value['status'], URL::createLink('admin', 'faq', 'ajaxStatus', array('id' => $id, 'status' => $value['status'])), $id);
									...
									$linkEdit	= URL::createLink('admin', 'faq', 'form', array('id' => $id));
		                           	echo  '<tr class="'.$row.'">
