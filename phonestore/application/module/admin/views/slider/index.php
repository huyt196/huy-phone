<?php 
	...
	// Pagination
	$paginationHTML		= $this->pagination->showPagination(URL::createLink('admin', 'slider', 'index'));
                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
								...
								<th width="7%"><?php echo $lblCategory;?></th>
				...
				<?php 
							if(!empty($this->Items)){
								...
								foreach($this->Items as $key => $value){
									...
									$picture 	= Helper::createImage('slider', '', $value['picture'], array('width' => 60, 'height' => 90));									
									$row		= ($i % 2 == 0) ? 'row0' : 'row1';
