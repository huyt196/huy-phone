<?php 
	...
	$slbCategory		= Helper::cmsSelectbox('form[category_phone_id]', 'inputbox', $this->slbCategory, $dataForm['category_phone_id'], 'width: 180px');
	...
	if(isset($this->arrParam['id']) || $dataForm['id']){
		...
		$picture		= '<img src="'.UPLOAD_URL . 'slider' . DS . '' . $dataForm['picture'].'">';
	...
	$rowCategory	= Helper::cmsRowForm('Category-Phone ', $slbCategory);
			...
			<div class="width-100 fltlft">
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						<?php echo $rowName . $rowPicture .$rowCategory . $rowStatus  . $rowOrdering . $rowDescription . $rowID;?>
					</ul>
					<div class="clr"></div>
					<div>
						<?php echo $inputToken;?>
