<?php 
	...
	// Pagination
	$paginationHTML		= $this->pagination->showPagination(URL::createLink('admin', 'contact', 'index'));
                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="title"><?php echo $lblFullName;?></th>
								<th class="title"><?php echo $lblEmail;?></th>
								<th class="title"><?php echo $lblPhone;?></th>
				...
				<?php 
							if(!empty($this->Items)){
								...
								foreach($this->Items as $key => $value){
									...
									$row		= ($i % 2 == 0) ? 'row0' : 'row1';
									$status		= Helper::cmsStatus($value['status'], URL::createLink('admin', 'contact', 'ajaxStatus', array('id' => $id, 'status' => $value['status'])), $id);
