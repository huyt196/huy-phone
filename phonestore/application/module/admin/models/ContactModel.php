...
class ContactModel extends Model{
	...
	private $_columns = array('id', 'fullname', 'email', 'phone', 'title', 'content','created', 'created_by', 'modified', 'modified_by', 'status', 'ordering');
	private $_userInfo;
	...
	public function listItem($arrParam, $option = null){
		$query[]	= "SELECT `id`, `fullname`,`email`, `phone`, `title`, `content`, `created`, `created_by`, `modified`, `modified_by`, `status`, `ordering`";
		$query[]	= "FROM `$this->table` ";
		$query[]	= "WHERE `id` > 0";
