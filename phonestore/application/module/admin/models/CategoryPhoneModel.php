<?php
class CategoryPhoneModel extends Model{
	...
	public function __construct(){
		...
		$this->setTable(TBL_CATEGORYPHONE);
	...
	public function saveItem($arrParam, $option = null){
		...
		if($option['task'] == 'add'){
			$arrParam['form']['picture']	= $uploadObj->uploadFile($arrParam['form']['picture'], 'categoryphone');
			...
			$arrCategories	= $this->listItem($arrParam, array('task' => 'xml-categoryphone'));
			XML::createXML($arrCategories, 'categories.xml');
