...
class FaqModel extends Model{
	...
	private $_columns = array('id', 'question', 'answer', 'created', 'created_by', 'modified','modified_by', 'status', 'ordering');
	private $_userInfo;
	...
	public function listItem($arrParam, $option = null){
		$query[]	= "SELECT `id`, `question`,`answer`, `created`, `created_by`, `modified`, `modified_by`, `status`, `ordering`";
		$query[]	= "FROM `$this->table` ";
		$query[]	= "WHERE `id` > 0";
