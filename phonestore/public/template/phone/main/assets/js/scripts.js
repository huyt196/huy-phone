...
(function($) {
	...
	*===================================*/
	...
	function formatNumber (num) {
	 ...
	 /*============* step: mỗi lần kéo chuột cộng thêm bao nhiêu tiền*==============*/
	$('#price_filter').each( function() {
		...
		$filter_selector.slider({
			...
			slide: function( event, ui ) {
				$( "#flt_price" ).html(  formatNumber(ui.values[ 0 ]) + c + " - " + formatNumber(ui.values[ 1 ]) + c);
				$( "#price_first" ).val(ui.values[ 0 ]);
				$( "#price_second" ).val(ui.values[ 1 ]);
			}
		});
		$( "#flt_price" ).html(  formatNumber($filter_selector.slider( "values", 0 )) +c + " - "+ formatNumber($filter_selector.slider( "values", 1 )) + c );
	});
