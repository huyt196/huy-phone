<?php
	...
	$linkCategoryManager= URL::createLink('admin', 'categoryphone', 'index');
	$linkAddCategory	= URL::createLink('admin', 'categoryphone', 'form');
	$linkBookManager	= URL::createLink('admin', 'phone', 'index');
	$linkAddBook		= URL::createLink('admin', 'phone', 'form');
	...
	<div id="header-box">
        ...
        <div id="module-menu">
            ...
            <ul id="menu" >
				...
				<li class="node"><a href="#">Phone Shopping</a>
					<ul>
						<li class="node">
							<a class="icon-16-category" href="<?php echo $linkCategoryManager;?>">Category Manager</a>
							<ul id="menu-com-users-users" class="menu-component">
								<li><a class="icon-16-newarticle" href="<?php echo $linkAddCategory;?>">Add New Category Phone</a></li>
							</ul>
						</li>
						<li class="node">
							<a class="icon-16-article" href="<?php echo $linkBookManager;?>">Phone Manager</a>
							<ul id="menu-com-users-groups" class="menu-component">
								<li><a class="icon-16-newarticle" href="<?php echo $linkAddBook;?>">Add New Phone</a></li>
							</ul>
						</li>
					</ul>
				</li>
